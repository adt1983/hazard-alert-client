...
public class HazardTable extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("create table "
				...
				+ COLUMN_EFFECTIVE
				+ " integer not null, "
				+ COLUMN_ALERT_FULL_NAME
				+ " text not null, bb_ne_lat real not null, bb_ne_lng real not null, bb_sw_lat real not null, bb_sw_lng real not null, visible integer not null);");
