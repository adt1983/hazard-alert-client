...
/*
 * Not sure about this approach. We are currently (re)loading data in Map/List separately instead of caching results.
 * Maybe store results in Application or in a shared background Fragment? Seems messy.
...
public class MainActivity extends FragmentActivity {
	...
	public boolean onShowList(MenuItem view) {
		Log.d();
		listFragment.setFilter(mapFragment.getFilter());
	...
	public boolean onShowMap(MenuItem view) {
		Log.d();
		mapFragment.setFilter(listFragment.getFilter());
			...
			return new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
				...
				public void onDateSet(DatePicker view, int selectedYear, int selectedMonth, int selectedDay) {
					...
					if (visibleFragment == mapFragment) {
						AlertFilter filter = mapFragment.getFilter();
						filter.setMinEffective(cal.getTimeInMillis());
						mapFragment.setFilter(filter);
					}
					else if (visibleFragment == listFragment) {
						AlertFilter filter = listFragment.getFilter();
						filter.setMinEffective(cal.getTimeInMillis());
